...
def add_Ecode(string,x):
    string = string[0:len(string)//2] + str(x) + string[len(string)//2:]
    return string

def encrypter001(string):
    global encryption001
    return encrypter(string, encryption001,1)


def encrypter002(string):
    global encryption002
    return encrypter(string, encryption002,2)

def encrypter003(string):
    global encryption003
    return encrypter(string, encryption003,3)
